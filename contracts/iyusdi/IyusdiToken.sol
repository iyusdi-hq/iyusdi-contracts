...
contract IyusdiToken is ERC20 {
  ...
  constructor (string memory name, string memory symbol, address presaleFund, address lgeFund, address foundersFund, address fundraisingFund, address generalFund, address communityFund ) ERC20(name, symbol) {
